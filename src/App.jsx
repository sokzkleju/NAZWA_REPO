    ...
    const interval = setInterval(() => {
      ...
      setEvents(prevEvents => {
        const updatedEvents = prevEvents.map(event => {
          ...
          const withinReminder = now >= reminderTime && now < new Date(reminderTime.getTime() + 60000);
        ...
        <div className="p-4 max-w-6xl mx-auto">
          ...
          {tab === "quiz" && (
            <div className="bg-gray-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold mb-4">📝 Generator quizów</h2>
          ...
          {tab === "affirmations" && (
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              {affirmation && (
                <p className="mt-4 text-lg italic text-green-400">{affirmation}</p>
              )}
            </div>
          )}
        </div>
